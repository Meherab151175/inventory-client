...
const adminNavItems = [
    ...
    { to: "/dashboard/manage-product", icon: <BsFillPostcardFill className="text-2xl" />, label: "Manage Product" },
    // { to: "/dashboard/manage-applications", icon: <TbBrandAppleArcade className="text-2xl" />, label: "Applications" },
];
const sellerNavItem = [
    { to: "/dashboard/seller-home", icon: <FaHome className="text-2xl" />, label: "Home" },
    { to: "/dashboard/add-product", icon: <MdExplore className="text-2xl" />, label: "Add A product" },
    { to: "/dashboard/my-products", icon: <IoSchoolSharp className="text-2xl" />, label: "My Products" },
...
const user = [
    { to: "/dashboard/user-home", icon: <BiHomeAlt className="text-2xl" />, label: "Dashboard" },
    { to: "/dashboard/ordered-product", icon: <SiGoogleclassroom className="text-2xl" />, label: "My Order" },
    ...
    { to: "/dashboard/apply-seller", icon: <SiInstructure className="text-2xl" />, label: "Apply for Seller" },
];
const lastMenuItems = [
            ...
            >
                <div className="flex gap-x-4 items-center">
                    <img
                        ...
                        className={`cursor-pointer bg-gray-800 h-[40px] duration-500"
                            }`}
                    />
                    <h1
                ...
                {
                    role === 'seller' && <ul className="pt-6">
                        <p className={`ml-3 text-light-gray-4 ${!open && "hidden"}`}><small>MENU</small></p>
                        {sellerNavItem.map((menuItem, index) => (
                            <li key={index} className="mb-2">
                                <NavLink
                                    to={menuItem.to}
                                    className={({ isActive }) =>
