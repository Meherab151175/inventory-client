        ...
        <div className="">
            ...
            <form onSubmit={handleFormSubmit} className=" mx-auto p-6 bg-white rounded shadow">
                ...
                <div className="grid gap-3 md:grid-cols-2">
                    <div className="mb-6">
                        ...
                        <input
                            ...
                            type="number"
                            required
                            placeholder='How many number are available?'
                ...
                <div className="mb-6">
                    ...
                    <textarea placeholder='Description about your product' name="description" className='resize-none border w-full p-2 rounded-lg  border-secondary outline-none' rows="4"></textarea>
                </div>
